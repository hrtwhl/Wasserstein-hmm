...
$$
g(k) = \arg\min_{g}\; W_2^2\big(\mathcal{N}(\mu_{t,k}, \Sigma_{t,k}),\; \mathcal{N}(\mu_g, \Sigma_g)\big)
$$
...
$$
\mu_g \leftarrow (1-\eta)\mu_g + \eta \bar{\mu}_{t,g}, \quad
...
$$
\mu_t = \sum_g p_{t,g}\mu_g^{(r)}, \quad
\Sigma_t = \sum_g p_{t,g}\Sigma_g^{(r)}
$$
...
$$
\text{s.t.} \quad \mathbf{1}^\top w = 1,\quad 0 \leq w \leq w_{\max}
$$
